	...
	return (
		<>
				...
				<div className="flex-1 space-y-4 mt-5 md:mt-0">
					...
					<div>
						...
						<p>
							...
							yourself how we&apos;re redefining the way students
							live during their university years.
						</p>
					</div>
					<p>
						Your education is a journey, and we&apos;re here to make
						it extraordinary. Discover a new standard of student
						living with us.
					</p>
				</div>
			</div>
			...
			<div className="mb-20">
				...
				<p className="mb-10 ">
					At Benchmark Real Estate Company, we understand that finding
				...
				<div className="flex flex-wrap gap-10 mb-20">
					<div className="sm:w-[calc((100%_-_2.5rem)_/_2)] md:w-[calc((100%_-_2.5rem_*_2)_/_3)] text-center border py-10 px-10 rounded-2xl bg-primary/10 border-primary">
						...
						<p>
							We specialize in student housing, which means our
							properties are designed with your needs in mind.
							From quiet study spaces to vibrant common areas, we
							offer the perfect blend of comfort and convenience
					...
					<div className="sm:w-[calc((100%_-_2.5rem)_/_2)] md:w-[calc((100%_-_2.5rem_*_2)_/_3)] text-center border py-10 px-10 rounded-2xl bg-primary/10 border-primary">
						...
						<p>
							...
							universities and colleges, making it easy for you to
							commute to classes and access campus facilities
							without the hassle of long commutes.
						</p>
					</div>
					<div className="sm:w-[calc((100%_-_2.5rem)_/_2)] md:w-[calc((100%_-_2.5rem_*_2)_/_3)] text-center border py-10 px-10 rounded-2xl bg-primary/10 border-primary">
						<h3 className="font-bold text-xl mb-5">Safety First</h3>
						<p>
							Your safety is our top priority. Our properties
							feature advanced security systems and 24/7
							surveillance to ensure you can focus on your studies
							with peace of mind.
						</p>
					</div>
					<div className="sm:w-[calc((100%_-_2.5rem)_/_2)] md:w-[calc((100%_-_2.5rem_*_2)_/_3)] text-center border py-10 px-10 rounded-2xl bg-primary/10 border-primary">
						...
						<p>
							Enjoy the convenience of modern amenities, including
							high-speed internet, fully equipped kitchens,
							laundry facilities, and more, all designed to make
							your student life comfortable.
						</p>
					</div>
					<div className="sm:w-[calc((100%_-_2.5rem)_/_2)] md:w-[calc((100%_-_2.5rem_*_2)_/_3)] text-center border py-10 px-10 rounded-2xl bg-primary/10 border-primary">
						<h3 className="font-bold text-xl mb-5">
					...
					<div className="sm:w-[calc((100%_-_2.5rem)_/_2)] md:w-[calc((100%_-_2.5rem_*_2)_/_3)] text-center border py-10 px-10 rounded-2xl bg-primary/10 border-primary">
						...
						<p>
							...
							various budgets, ensuring that you can find a home
							that suits your financial needs without compromising
							on quality.
						</p>
					</div>
				</div>
